...
namespace MixedReality.Toolkit.Input
{
    ...
    public class PUNRiggedHandMeshVisualizer : MonoBehaviour
    {
        [SerializeField]
        ...
        protected void OnEnable()
        {
            ...
            if (view.IsMine) {
                this.view.RPC("UpdateRendererState", RpcTarget.Others, handRenderer.enabled);
            }
        ...
        private void Update()
        {
            // Add streaming data out when view is mine
            if (view.IsMine)
            {
                ...
                // Stream the data out
                this.view.RPC("UpdateHandScale", RpcTarget.Others, transform.localScale);
        ...
        [PunRPC]
        void UpdateHandScale(Vector3 scale)
        {
            transform.localScale = scale;
        }
        [PunRPC]
        void UpdateRendererState(bool isEnabled)
        {
           handRenderer.enabled = isEnabled;
        }
